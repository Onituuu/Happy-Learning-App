...
public class VideoBelajar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_belajar);
        ...
        FirebaseStorage.getInstance().getReference().child("videos").listAll().addOnSuccessListener(new OnSuccessListener<ListResult>() {
            ...
            public void onSuccess(ListResult listResult) {
                ...
                VideoAdapter adapter = new VideoAdapter(VideoBelajar.this, arrayList);
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(VideoBelajar.this, "Failed to retrieve videos", Toast.LENGTH_SHORT).show();
            }
        });
    }
}